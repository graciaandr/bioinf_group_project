...
def extract_fields(function,file):
    ...
    print(len(converted2.values()))
      ...
      #     num_to_letter = replace('0|0', ref + ref)
       #    converted.append(num_to_letter)
        # elif '0|1' in rec:
         #   num_to_letter = replace('0|1', ref + alt)
          #  converted.append(num_to_letter)
         #elif '1|0' in rec:
          #  num_to_letter = replace('1|0', alt + ref) 
           # converted.append(num_to_letter)
         #else:
          #  'naN' in rec
           # num_to_letter= 'NAn'
            #converted.append(num_to_letter)
            #converted = '/t'.join(converted)
    #print(converted)
